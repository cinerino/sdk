...
import * as  ErrorFactory from './implicitGrantClient/error';
import PopupAuthenticationHandler from './implicitGrantClient/popupAuthenticationHandler';
import SilentAuthenticationHandler from './implicitGrantClient/silentAuthenticationHandler';
import SilentLogoutHandler from './implicitGrantClient/silentLogoutHandler';
// tslint:disable-next-line:no-require-imports no-var-requires
const idTokenVerifier = require('idtoken-verifier');

import ICredentials from './implicitGrantClient/credentials';
